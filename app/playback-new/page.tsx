...
export default function PlaybackNewPage() {
          ...
          {!isPlaying && currentLine === -1 && !showEnd && (
            <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
              <textarea
                ...
                className="w-full max-w-4xl h-full bg-transparent text-white resize-none focus:outline-none"
                style={{
          ...
          {!isPlaying && currentLine === -1 && !showEnd && (
            <div className="absolute bottom-8 left-0 right-0 text-center text-gray-500 text-sm">
              <div className="inline-flex gap-6">
                ...
                <span><kbd className="bg-gray-800 px-2 py-1 rounded">←/→</kbd> Prev/Next Line</span>
                ...
                <span><kbd className="bg-gray-800 px-2 py-1 rounded">Esc</kbd> Exit</span>
              </div>
            </div>
          )}
        </div>
